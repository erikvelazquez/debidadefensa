...
@Component({
    selector: 'jhi-cliente-my-suffix',
    templateUrl: './cliente-my-suffix.component.html'
})
export class ClienteMySuffixComponent implements OnInit, OnDestroy {
    ...
    loadAll() {
        if (this.currentSearch) {
            this.clienteService.search({
                ...
                (res: HttpResponse<ClienteMySuffix[]>) => this.onSuccess(res.body, res.headers),
    ...
    trackId(index: number, item: ClienteMySuffix) {
        return item.id;
    }
