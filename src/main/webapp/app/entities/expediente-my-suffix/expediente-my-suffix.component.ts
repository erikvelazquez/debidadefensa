...
@Component({
    selector: 'jhi-expediente-my-suffix',
    templateUrl: './expediente-my-suffix.component.html'
})
export class ExpedienteMySuffixComponent implements OnInit, OnDestroy {
    ...
    loadAll() {
        if (this.currentSearch) {
            this.expedienteService.search({
                ...
                (res: HttpResponse<ExpedienteMySuffix[]>) => this.onSuccess(res.body, res.headers),
    ...
    trackId(index: number, item: ExpedienteMySuffix) {
        return item.id;
    }
