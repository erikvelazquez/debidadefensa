...
@Component({
    selector: 'jhi-costo-servicio-my-suffix',
    templateUrl: './costo-servicio-my-suffix.component.html'
})
export class CostoServicioMySuffixComponent implements OnInit, OnDestroy {
costoServicios: CostoServicioMySuffix[];
    currentAccount: any;
        ...
        if (this.currentSearch) {
            this.costoServicioService.search({
                query: this.currentSearch,
                    ...
                    (res: HttpResponse<CostoServicioMySuffix[]>) => this.costoServicios = res.body,
                    (res: HttpErrorResponse) => this.onError(res.message)
                );
            return;
       }
        this.costoServicioService.query().subscribe(
            (res: HttpResponse<CostoServicioMySuffix[]>) => {
    ...
    trackId(index: number, item: CostoServicioMySuffix) {
        return item.id;
    }
