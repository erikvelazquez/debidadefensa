...
describe('Service Tests', () => {
    ...
    describe('ExpedienteMySuffix Service', () => {
        ...
        beforeEach(() => {
            ...
            injector = getTestBed();
            service = injector.get(ExpedienteMySuffixService);
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                const resourceUrl = SERVER_API_URL + 'api/expedientes';
                expect(req.request.url).toEqual(resourceUrl + '/' + 123);
            });
            it('should return ExpedienteMySuffix', () => {
