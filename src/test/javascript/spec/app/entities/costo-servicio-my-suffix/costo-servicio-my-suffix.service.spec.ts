...
describe('Service Tests', () => {
    ...
    describe('CostoServicioMySuffix Service', () => {
        ...
        beforeEach(() => {
            ...
            injector = getTestBed();
            service = injector.get(CostoServicioMySuffixService);
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                const resourceUrl = SERVER_API_URL + 'api/costo-servicios';
                expect(req.request.url).toEqual(resourceUrl + '/' + 123);
            });
            it('should return CostoServicioMySuffix', () => {
