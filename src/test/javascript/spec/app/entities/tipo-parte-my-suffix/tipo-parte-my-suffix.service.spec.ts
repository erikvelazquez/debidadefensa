...
describe('Service Tests', () => {
    ...
    describe('TipoParteMySuffix Service', () => {
        ...
        beforeEach(() => {
            ...
            injector = getTestBed();
            service = injector.get(TipoParteMySuffixService);
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                const resourceUrl = SERVER_API_URL + 'api/tipo-partes';
                expect(req.request.url).toEqual(resourceUrl + '/' + 123);
            });
            it('should return TipoParteMySuffix', () => {
