...
describe('Service Tests', () => {
    ...
    describe('EstatusMySuffix Service', () => {
        ...
        beforeEach(() => {
            ...
            injector = getTestBed();
            service = injector.get(EstatusMySuffixService);
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                const resourceUrl = SERVER_API_URL + 'api/estatuses';
                expect(req.request.url).toEqual(resourceUrl + '/' + 123);
            });
            it('should return EstatusMySuffix', () => {
