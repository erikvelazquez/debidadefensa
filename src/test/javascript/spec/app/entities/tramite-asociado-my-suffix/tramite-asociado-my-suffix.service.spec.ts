...
describe('Service Tests', () => {
    ...
    describe('TramiteAsociadoMySuffix Service', () => {
        ...
        beforeEach(() => {
            ...
            injector = getTestBed();
            service = injector.get(TramiteAsociadoMySuffixService);
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                const resourceUrl = SERVER_API_URL + 'api/tramite-asociados';
                expect(req.request.url).toEqual(resourceUrl + '/' + 123);
            });
            it('should return TramiteAsociadoMySuffix', () => {
