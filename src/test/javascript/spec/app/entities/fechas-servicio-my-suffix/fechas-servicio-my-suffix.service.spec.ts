...
describe('Service Tests', () => {
    ...
    describe('FechasServicioMySuffix Service', () => {
        ...
        beforeEach(() => {
            ...
            injector = getTestBed();
            service = injector.get(FechasServicioMySuffixService);
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                const resourceUrl = SERVER_API_URL + 'api/fechas-servicios';
                expect(req.request.url).toEqual(resourceUrl + '/' + 123);
            });
            it('should return FechasServicioMySuffix', () => {
