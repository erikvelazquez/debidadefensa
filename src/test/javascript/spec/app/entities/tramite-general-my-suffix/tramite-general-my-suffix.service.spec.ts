...
describe('Service Tests', () => {
    ...
    describe('TramiteGeneralMySuffix Service', () => {
        ...
        beforeEach(() => {
            ...
            injector = getTestBed();
            service = injector.get(TramiteGeneralMySuffixService);
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                const resourceUrl = SERVER_API_URL + 'api/tramite-generals';
                expect(req.request.url).toEqual(resourceUrl + '/' + 123);
            });
            it('should return TramiteGeneralMySuffix', () => {
