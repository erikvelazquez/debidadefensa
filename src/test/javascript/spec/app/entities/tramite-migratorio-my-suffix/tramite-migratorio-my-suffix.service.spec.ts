...
describe('Service Tests', () => {
    ...
    describe('TramiteMigratorioMySuffix Service', () => {
        ...
        beforeEach(() => {
            ...
            injector = getTestBed();
            service = injector.get(TramiteMigratorioMySuffixService);
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                const resourceUrl = SERVER_API_URL + 'api/tramite-migratorios';
                expect(req.request.url).toEqual(resourceUrl + '/' + 123);
            });
            it('should return TramiteMigratorioMySuffix', () => {
